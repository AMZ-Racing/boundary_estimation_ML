...
class TrackGenerator:
    ...
    def self_intersects(points, slopes, margin):
        ...
        return TrackGenerator._slf_intrsct_recurse(tmp1) or TrackGenerator._slf_intrsct_recurse(
            tmp2
        )
    ...
    def pick_starting_point(
        ...
        start_index = (
            ...
            * indices[
                np.argmin(
                    TrackGenerator._cyclic_smooth(indices, positions, curvature, smooth_diameter)
                )
            ]
        )
